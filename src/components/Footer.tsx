          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                target="_blank"
                className="w-10 h-10 rounded-full glass flex items-center justify-center text-white/80 hover:text-primary1 transition-colors"
              >
                <Github size={18} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-white/70">
                ...
                <span>work.gundeep@gmail.com</span>
              </li>
              <li className="flex items-center text-white/70">
                <svg
