        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-white/80 max-w-xl animate-fade-in animate-delay-200">
              I'm a first-year BCA student at Christ University, passionate about creating beautiful, responsive websites with modern technologies and building exceptional digital experiences.
            </p>
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in-right">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden fancy-border-gradient">
                <img 
                  src="/lovable-uploads/0def0179-1bef-401e-bbfa-7a55391ea020.png" 
                  alt="Gundeep Marwah"
