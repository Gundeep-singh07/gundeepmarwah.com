  ...
  const allProjects: Project[] = [
    {
      ...
      description: "A fully responsive e-commerce website built with React and Node.js, featuring product listings, cart functionality, and payment integration.",
    ...
    },
    {
      ...
      description: "A customizable portfolio template for developers, featuring smooth animations and a modern design.",
    ...
    },
    {
      ...
      description: "A productivity app that helps users manage tasks, set priorities, and track progress with intuitive UI.",
      ...
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
          ...
          <p className="text-lg text-white/80">
            Check out some of my recent projects. Each project represents my dedication to creating 
            functional, beautiful, and user-friendly web applications.
          </p>
        </div>
